...
/* Your sheet ID
/* ------------------------------------------------------------------- */
let sheetID = "1TjUnMoaGR66MAq2ZAwCI_J_TRRVM0T_yWuhkKO6BcxQ";
...
let options = {
    ...
    inventory: {
        ...
        itemAmount: 24,
        sortTypes: ['Currency', 'Character Slot', 'Crafting Material', 'Consumable', 'Skill Item'],
